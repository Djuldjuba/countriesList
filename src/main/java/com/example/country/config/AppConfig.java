...
public class AppConfig {
    ...
    public static final String SOAP_NAMESPACE = "countriesList";

    @Value("${countriesList.base-uri}")
    ...
    public XsdSchema countriesSchema() {
        return new SimpleXsdSchema(new ClassPathResource("countriesList.xsd"));
    }
}
